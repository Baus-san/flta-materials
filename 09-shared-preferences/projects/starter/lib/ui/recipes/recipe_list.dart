...
class _RecipeListState extends State<RecipeList> {
                ...
                children: <Widget>[
                  Expanded(
                    ...
                    child: TextField(
                      ...
                      autofocus: false,
                      // Closes the keyboard when the user presses the Done btn
                  ...
                  PopupMenuButton<String>(
                    ...
                    itemBuilder: (BuildContext context) {
                      ...
                      // (see widgets/custom_dropdown.dart) to display previous searches.
  ...
  void startSearch(String value) {
    ...
    setState(() {
      ...
      // Check to make sure the search text
      // hasn’t already been added to the previous search list.
      if (!previousSearches.contains(value)) {

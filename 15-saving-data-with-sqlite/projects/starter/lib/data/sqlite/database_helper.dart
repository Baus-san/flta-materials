...
class DatabaseHelper {
  ...
  Future<List<Recipe>> findAllRecipes() async {
    ...
    final recipes = parseRecipe(recipeList);
    return recipes;
  }
  ...
  Future<List<Ingredient>> findRecipeIngredients(int id) async {
    final db = await instance.streamDatabase;
    final ingredientList = await db.query(ingredientTable, where: 'id = $id');
    final ingredients = parseIngredient(ingredientList);
    return ingredients;
  }
  ...
  Future<int> deleteRecipeIngredients(int id) async {
    final db = await instance.streamDatabase;
    return db.delete(ingredientTable, where: '$recipeId = id', whereArgs: [id]);
  }
